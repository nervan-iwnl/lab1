...
1. **Git и GitHub.** В истории репозитория есть отдельная ветка
   ...
   Репозиторий опубликован на GitHub: <https://github.com/nervan-iwnl/lab1>.
...
Удалённый репозиторий подключён как `origin`. Ветки `main` и `feature-branch`
опубликованы на GitHub; дальнейшие изменения оформляются через Pull Request.
